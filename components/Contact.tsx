  ...
  return (
    <>
      ...
      <AnimatedSection>
        ...
        >
          <div className="section-label text-accent-gold text-sm md:text-base uppercase tracking-wider mb-4">
            Contact
          </div>
          
          <h2 className="text-[2.5rem] md:text-[3rem] lg:text-[3.5rem] font-extrabold mb-6">
            Let&apos;s <span className="font-crimson italic font-normal text-accent-sand">build</span> something
          </h2>
          
          <p className="font-crimson text-base md:text-lg text-text-muted mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex justify-center gap-12 mb-16">
            ...
            <a 
              ...
              className="text-sm md:text-base font-bold uppercase tracking-[0.15em] px-8 py-4 bg-accent-rust border border-accent-rust transition-all duration-300 ease-in-out hover:bg-accent-gold hover:border-accent-gold hover:text-bg-dark"
            >
              Email Me
            </a>
